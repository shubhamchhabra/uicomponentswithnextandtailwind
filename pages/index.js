...
export default function Home() {
  ...
  return (
    <>
      <Meta 
        title={'UI Components - Tailwind Components'} 
        description="UI Components a collection of free Tailwind CSS components to bootstrap your new apps, projects or landing pages!" 
        />
