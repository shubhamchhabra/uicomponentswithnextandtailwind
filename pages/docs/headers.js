  ...
  return (
    <section className="lg:px-12 px-3 ">
      <Meta
        ...
        description={
          "UI Components offers a wide range of responsive NavBars, including outlined navbar, animated hamburger menus, ...."
        }
      ...
      <PageHeading
        ...
        alt={"header"}
        description={
          "The Header component is needed in applications and websites as a site must have a form of navigation for users, UI Components offers a wide range of responsive NavBars, including outlined navbar with animated hamburger menus for mobile state."
        }
      />
